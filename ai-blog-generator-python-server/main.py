...
DB_PATH = os.environ.get("DB_PATH", "data/ai_blog_server.db")
ROOT_PATH = str(os.environ.get("ROOT_PATH", "") or "").rstrip("/")
...
app.add_middleware(
    ...
    session_cookie=os.environ.get("SESSION_COOKIE_NAME", "aiblog_session"),
