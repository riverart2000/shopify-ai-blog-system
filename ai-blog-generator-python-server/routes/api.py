...
async def api_social_generate(request: Request, payload: SocialGenerateRequest):
    ...
    return {
        ...
        "image_reference_url": generated.get("image_reference_url", product_image_url),
        "image_reference_attached": generated.get("image_reference_attached", bool(product_image_url)),
        "image_reference_available": generated.get("image_reference_available", bool(product_image_url)),
        "image_reference_used_in_ai_generation": generated.get("image_reference_used_in_ai_generation", False),
        "product_image_included_in_results": generated.get("product_image_included_in_results", bool(product_image_url)),
        "product_image_fallback_active": generated.get("product_image_fallback_active", False),
        "text_generation_prompt": generated.get("text_generation_prompt", ""),
