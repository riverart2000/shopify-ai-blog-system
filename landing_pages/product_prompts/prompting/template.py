...
class TemplatePromptGenerator(PromptGenerator):
    ...
    def build_persona(self, product: Product, blog: BlogContent) -> ClientPersona:
        ...
        # Infer sex.
        if re.search(r"\b(women|woman|her|female|she)\b", text):
            sex = "woman"
        elif re.search(r"\b(men|man|his|male|he|beard)\b", text):
            sex = "man"
        else:
            sex = "woman"  # beauty/wellness default; Grok refines this
